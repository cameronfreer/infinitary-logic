...
(`Admissible/Family.lean`, `Admissible/Theory.lean`, `Admissible/Ambient.lean`,
`Admissible/Fragment/Honest.lean`, `Admissible/HF.lean`).
...
#check FirstOrder.Language.AmbientPresentation.CompactFor
