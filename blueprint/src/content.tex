...
\begin{itemize}
  ...
  \item \textbf{Model existence.}
    Every consistent set of sentences of $\Lomegaone$ has a model
    (Theorem~\ref{thm:model-existence}).
...
This theorem applies to coded $\mathbb{N}$-models whose Scott height is uniformly
bounded below~$\omegaone$.  The general Morley counting theorem for all countable
models of an arbitrary $\Lomegaone$ sentence---without restricting to
$\mathbb{N}$-codings or imposing a Scott-height bound---remains a separate target.
