...
of that package is supplied here.  Only the direction perfect antichain
$\to$ Cantor antichain is currently formalized; the converse requires showing
...
retains nothing from which a perfect set could be extracted, so the current
cardinal interface cannot itself produce a perfect-set witness.
