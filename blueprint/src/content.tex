...
classes of countable models.  The full Morley counting theorem (with
$\leq \aleph_1$ replacing $\leq \aleph_0$) remains a separate target requiring
Scott-height stratification.
