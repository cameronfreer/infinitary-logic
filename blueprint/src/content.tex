...
hypotheses.  Its two inputs are both formalized: tail-restricted source
extraction (\texttt{morleyHanfExtractionTail\_holds}, countable Ramsey on the
Morley seed --- no Erd\H{o}s--Rado schedule is consumed), and realizability of
the seed's Ehrenfeucht--Mostowski tail-template theory over every target order
