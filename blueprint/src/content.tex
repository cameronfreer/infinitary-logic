...
(\texttt{silverBurgessDichotomy}) is proved modulo one sorry in the
Borel-to-closed reduction (\texttt{silver\_core\_polish}), which requires the
Gandy--Harrington topology or equivalent descriptive-set-theoretic infrastructure
not yet available in Mathlib.  Once this is filled, \texttt{morley\_counting}
