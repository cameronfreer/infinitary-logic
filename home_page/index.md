...
**Sorry-free**, with every headline result depending on exactly the three standard axioms `propext`, `Classical.choice`, `Quot.sound`. Latest release: [**v1.6.1**](https://github.com/cameronfreer/infinitary-logic/releases/latest).
...
- **Craig interpolation** &mdash; sharp shared-vocabulary interpolants over **arbitrary** languages, with the PC-separation form.
